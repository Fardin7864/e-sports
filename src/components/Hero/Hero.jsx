    ...
    <div className="bg-gradient-to-b from-[#1c153f] to-[#1c153f] h-[1700px] overflow-hidden">
      ...
      {/* Accourdion */}
        ...
        {/* About text */}
          ...
          <div className=' z-40 absolute flex justify-start items-start lg:top-[1800px] top-[1092px] md:top-[1324px] lg:-left-30 md:-left-20 -left-14'>
        ...
        {/* About  */}
        <div className='z-40 absolute flex flex-col md:flex-row justify-start items-start lg:top-[1700px] top-[992px] md:top-[1274px] lg:left-52 md:left-28 left-28'>
          <div className=' lg:hidden border-2 rounded-lg border-[#be006b]'>
          <iframe width="250px" src="https://www.youtube.com/embed/LsiaQim9AiY?si=o86NvGLW7vIueZ18" title="" frameBorder="0" allow="" className='rounded-lg'></iframe>
          </div>
          ...
          <div className='px-7'>
                <h4 className=' text-xl lg:text-3xl text-white font-medium lg:px-4'>Anubis is a fastest growing global esports and tech event management agency</h4>
                <p className='text-lg md:text-xs hidden md:block text-gray-300 font-medium px-4 mt-4'>Industry leaders in the project management of esports. If you are a company looking for an esports marketing agency, <span className=' hidden lg:block'>with experience with the latest video games, our team is here to help: we’ve produced global esports tournaments across every continent, for 100 clients - from leading consumer brands, to the world’s biggest video game developers,</span> to global and local sporting organizations. Whichever industry you are in: we have proven experience to successfully introduce your business and services to gaming audiences.</p>
          </div>
        </div>
        <div className='z-40 absolute flex justify-start items-start lg:top-[2000px] w-96 md:w-[500px] top-[1292px] md:top-[1490px] lg:left-[1017px] md:left-[266px] left-10'>
          <div>
            <img src={gamer} alt="" />
          </div>
        </div>
       ...
       <div className=' z-30 absolute flex justify-start items-start lg:top-[2400px] top-[1692px] md:top-[2024px] lg:left-48 md:left-20 left-14 border-b-4 border-[#be006b]'>
            <h3 className=' transform text-center  lg:text-9xl md:text-7xl text-6xl font-extrabold text-white '> Our <br className='md:hidden'/> <span className='bg-gradient-to-r from-[#be006b] to-[#e33b54] text-transparent  bg-clip-text'>Services</span>
            </h3>
          </div>
    </div>
  );
